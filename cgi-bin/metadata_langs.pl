...
metadata_langs.pl - return available languages

=head1 SYNOPSIS

metadata_langs.pl [options]

=head1 DESCRIPTION

Return languages for which texts have been indexed.
...
The Original Code is metadata_langs.pl.
